...
argparse/__main__ despite its SKILL.md documenting an --app-name CLI).
"""
...
def main():
    parser = argparse.ArgumentParser(description="Generate a serverless AWS stack template.")
    parser.add_argument("--app-name", required=True, help="Application name (used for resource naming)")
    parser.add_argument("--region", default="us-east-1", help="AWS region")
    parser.add_argument("--format", choices=["cloudformation", "cdk", "terraform"], default="cloudformation")
    parser.add_argument("--output", help="Write the template to this path instead of stdout")
